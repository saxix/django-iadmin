# -*- coding: utf-8 -*-
#
# django-iadmin documentation build configuration file, created by
...
#sys.path.insert(0, os.path.abspath('../../testprj'))
...
version = iadmin.get_version(short=True)
# The full version, including alpha/beta/rc tags.
release = iadmin.get_version(short=True)
next_version = '0.1.9'
...
htmlhelp_basename = 'django-iadmindoc'

#modindex_common_prefix = ["iadmin."]
...
latex_documents = [
  ('index', 'django-iadmin.tex', u'django-iadmin Documentation',
   u'Sax', 'manual'),
]
...
man_pages = [
    ('index', 'django-iadmin', u'django-iadmin Documentation',
     [u'Sax'], 1)
]


# Example configuration for intersphinx: refer to the Python standard library.
intersphinx_mapping = {'py':{'http://docs.python.org/2.6': None},
