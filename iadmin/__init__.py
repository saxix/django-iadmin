...
#def iautodiscover(selected_site=None, module='admin'):
#    """
...
#        from iadmin.sites import site as selected_site
#
#    for app in settings.INSTALLED_APPS:
#        try:
#            django.contrib.admin.sites.site, bak = selected_site, django.contrib.admin.site
